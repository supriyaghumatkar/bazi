    ...
    <div class="row">
		...
		<!--  Error -Success Messages -->
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form id="report-personaldetail-form" action="<?php echo base_url(); ?>report" method="post" role="form">
                               <input type="hidden" value="<?php echo $this->input->get('report_id');  ?>" name="reportid" id="reportid"/>
